...
CONFIG = {
    # Input data
    #'sop4_filter': 'data/dataset_sop4/sop4_all_filtered_nodules.csv', # sop4
    #'sop4_filter': 'data/dataset_sop4/sop4_with_all_features_tr13_extra.csv', # add TR1~3
    'sop4_filter': '/train/data/251016-efficientNet/dataset_table/all_matched_sop_v5.csv', # 20240809 for verify
    'project_root': './runs/us_feature_classify_v2',
    
    # Image directories
    'image_root': '/opt/dlami/nvme/extra_images', #input image folder
    'us_image_root': '/opt/dlami/nvme/us-images/2cropped_us_images', 
    'nodule_image_root': '/opt/dlami/nvme/us-images/3nodule_images',
    
    # Log files
    'fail_log': 'data/dataset_sop4/sop4_fail_log.txt',
    'fail_nodule_log': 'data/dataset_sop4/sop4_fail_nodule_log.txt',
    
    # Model paths (YOLOv11 models)
    'yolo_us_nodule_segment_model': '/train/data/251016-efficientNet/models/nodule_us_segment_model_v3_best.pt',
    'yolo_us_region_detector': '/train/data/251016-efficientNet/models/us_region_detector_v2_best.pt',
    
    # Processing parameters
    'batch_size': 32,
    'nodule_expansion_ratio': 0.5,  # 50% expansion on each side
    'nodule_minimux_size': 60,
    'debug_mode': False,
                    ...
                    try:
                        ...
                        if hasattr(result, 'masks') and result.masks is not None and len(result.masks) > 0:
                            ...
                            if contours:
                                ...
                                w = max(CONFIG['nodule_minimux_size'], w)  # if width too small makt it as least to threshold.
                                h = max(CONFIG['nodule_minimux_size'], h)
...
def main():
    ...
    try:
        ...
        sop4_filter_path = CONFIG['sop4_filter']
