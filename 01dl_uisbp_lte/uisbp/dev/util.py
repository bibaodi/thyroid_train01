...
* in-repository data directory path resolution and lazy creation
"""
import os
...
# prefer passing these to `find_custom_data_dir` or at least using these as the basis for custom paths
RAW_DATA_DIR = "raw"
WORK_DATA_DIR = "work"
PREPROCESSED_DATA_DIR = "preprocessed"
FEATURES_DATA_DIR = "features"
TRAINING_DATA_DIR = "train"
HOLDOUT_DATA_DIR = "holdout"
MODEL_DATA_DIR = "model"
EVALUATION_DATA_DIR = "evaluation"
