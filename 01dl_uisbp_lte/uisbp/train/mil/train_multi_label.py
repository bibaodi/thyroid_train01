...
def train(dataset_train, dataset_val, model_callable_name, num_classes,
    ...
    with tf.Graph().as_default():
        ...
        mdl = model_func(input_placeholder=img_, num_classes=num_classes, input_scale=input_scale, is_training=True, give_summary=True)    
            
        pool_out, fc_out = mdl.outputs
        ...
        prediction = scoring.create_prediction_multi_label(fc_out)
        score = scoring.create_score_multi_label(fc_out)      
