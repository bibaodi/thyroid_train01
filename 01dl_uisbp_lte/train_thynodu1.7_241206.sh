...
function run_segtrain {
    ...
    python scripts/train_segmentation_thyroid_tf2.py --datapath /train/data/$DATADIR/np_data \
	    ...
	    --combine_train_valid  \
	    --checkpoint /train/history_train/res_tryThyNod_axpG31Only_mul_nodules1.3_axp31_224_20241203T1937_sz224/linknet18_32_0.5_multi_224/weights.h5 \
...
Purpose='thyNod1.7PurgeNoLabelImgs'

echo ${Purpose} '|no-augmentation'

#DATA='mul_nodules1.1_axp10'
DATA='mul_nodules1.6_axpG63purge_224'
