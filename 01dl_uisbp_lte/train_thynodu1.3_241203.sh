...
function run_segtrain {
    ...
    python scripts/train_segmentation_thyroid_tf2.py --datapath /train/data/$DATADIR/np_data \
	    ...
	    ##--checkpoint /train/history_train/res_tryThyNod_mul_nodules1.1_axp10_20241201T1253_sz96/linknet18_32_0.5_multi_96/weights.h5 \
#--use_augmentation 
...
Purpose='tryThyNod_axpG31Only'

echo ${Purpose} '|no-augmentation'

#DATA='mul_nodules1.1_axp10'
DATA='mul_nodules1.3_axp31_224'
