...
if __name__ == '__main__':
    ...
    parser.add_argument('--outdir', dest='outdir', type=str, default=f'.{os.sep}results{os.sep}',
    ...
    restore_op_name = f"save{os.sep}restore_all"
    filename_tensor_name = f"save{os.sep}Const:0"
