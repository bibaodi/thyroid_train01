...
run_annotation() {
    ...
    local cmd=(
        ...
        --model_file /mnt/datas/42workspace/34-project_ML_data_models_UltrasoundIntelligence/44-models/3-thyroid/model_SegmentThynodu_v02.250315/model_SegmentThynodu_v02.250315.pt 
        --label_name thyNodu
...
get_prompt_message() {
    ...
    case "${copy_mode:-}" in
        ...
        only)
            ...
            ;;
        *)
            echo "Process subfolder '$subfolder'? [y/n/a/q] "
            ;;
    esac
}
